    ...
    axios.post('http://localhost:3000/user/signin', userData)
      .then((res) => {
        ...
        setModal({
          ...
          content: `Welcome, ${res.data.user ? res.data.user.firstName : 'User'}!`,
          onClose: () => {
        ...
        setModal({
          show: true,
          title: 'Login Failed',
          content: `Login failed, ${err.response ? err.response.data : 'Unknown error occurred'}`,
            ...
            <div className="auth-form">
              <div className="container mx-auto">
                ...
                <div className="social-account-container">
                  <span className="title">Don't have an account yet <Link to='/signup'>Sign up</Link></span>
                </div>
